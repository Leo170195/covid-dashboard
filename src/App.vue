<template>
  <div id="app">
    <h1 class="text-center my-5 text-bs"><img src="/../favicon.ico" class="me-3">Covid Dashboard Italiana</h1>
    <h4 class="text-bs w-100 mb-4 text-center">Bollettino giornaliero: {{ newCases }}</h4>
    <div id="today" class="text-center my-2" >
    ...
    <div class="container my-5">
        <div class="row">
            <div class="col-6 col-lg-3 mb-4">
                <div class="card-neo h-100" @click="show()">
                    <div class="card-body">
                        <h4 class="card-title text-bs mb-5">Casi Totali</h4>
                        <p id="total-cases" class="text-end text-b h5 mt-5">
                            {{ totalCases }}
                        </p>
                    </div>
                </div>
            ...
            <div class="col-6 col-lg-3 mb-4">
                <div class="card-neo h-100">
                    <div class="card-body">
                        <h4 class="card-title text-bs mb-5">Morti Totali</h4>
                        <p id="total-death" class="text-end text-b h5 mt-5">
                            {{ totalDeath }}
                        </p>
                    </div>
                </div>
            ...
            <div class="col-6 col-lg-3 mb-4">
                <div class="card-neo h-100">
                    <div class="card-body">
                        <h4 class="card-title text-bs mb-5">Guariti Totali</h4>
                        <p id="total-healed" class="text-end text-b h5 mt-5">
                            {{ totalHealed }}
                        </p>
                    </div>
                </div>
            ...
            <div class="col-6 col-lg-3 mb-4">
                <div class="card-neo h-100">
                    <div class="card-body">
                        <h4 class="card-title text-bs mb-5">Attualmente Positivi</h4>
                        <p id="positive" class="text-end text-b h5 mt-5">
                            {{ positive  }}
                        </p>
                    </div>
                </div>
            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-12 text-center mb-5">
                        <h4 class="text-center text-bs">Giorno selezionato <strong> {{ dayPrint }}</strong></h4>
                        
                        <label for="datePicker" class="form-label">Seleziona manualmente</label>
                        <br>
                        <input type="date" class="form-data my-2 mx-1" min="2020-02-24" :max="maxDayForInput" id="datePicker" v-model="dayMaxDate">
                        <br>
                        <label for="day">o scorri la barra</label>
                        <input type="range" class="form-range my-2" id="day" v-model="dayMax">
                    ...
                    <div class="col-12 col-lg-6 p-4">
                        ...
                        viewBox="0 0 750 900" xml:space="preserve" width="100%" style="max-width: 500px; filter: drop-shadow(1px 1px 1px #cdcdcd);">
                        
                        <g id="map-of-italy" transform="translate(-2.000026,-112.0499)">
                            <path fill="#B0171F" data-region="Valle d'Aosta" d="M63.759,213.32c-5.313,1.354-9.802,6.954-15.825,5.334
                            ...
                            <path fill="#B0171F" data-region="Piemonte" d="M76.352,371.395c0.758,0.629,3.199,1.311,5.424,1.515
                            ...
                            <path fill="#B0171F" data-region="Lombardia" d="M168.53,320.902c-0.449-2.394-0.13-3.692,1.317-5.361
                            ...
                            <path fill="#B0171F" data-region="Emilia-Romagna" d="M341.22,402.06c1.391-3.22,2.529-7.678,2.601-10.194
                            ...
                            <path fill="#B0171F" data-region="Liguria"
                            ...
                            <g id="g2992" transform="matrix(0.948312,0,0,0.948312,-83.88148,51.95865)">
                                <path fill="#B0171F" data-region="Toscana"
                            ...
                            <path fill="#B0171F" data-region="Marche"
                            ...
                            <path fill="#B0171F" data-region="P.A. Bolzano" d="M360.006,148.629c-1.309-0.701-2.381-1.859-2.381-2.574c0-3.682-7.452-14.501-9.988-14.501
                            ...
                            L360.006,148.629z" />
                            <path fill="#B0171F" data-region="P.A. Trento"
                            ...
                            <g transform="matrix(0.948312,0,0,0.948312,-83.88148,51.95865)">
                                <path fill="#B0171F" data-region="Veneto" d="M508.071,192.742c-1.375-2.85-2.5-5.908-2.5-6.794c0-1.254-0.778-1.521-3.5-1.203
                            ...
                            <g id="g2981" transform="matrix(0.948312,0,0,0.948312,-83.88148,51.95865)">
                                <path fill="#B0171F" data-region="Friuli Venezia Giulia"
                            ...
                            <g id="g3019" transform="matrix(0.948312,0,0,0.948312,-83.88148,51.95865)">
                                <path fill="#B0171F" data-region="Sicilia"
                            ...
                            <path fill="#B0171F" data-region="Calabria" d="M586.708,876.267c1.126-1.667,2.343-5.261,2.705-7.987
                            ...
                            <g id="g3015" transform="matrix(0.948312,0,0,0.948312,-83.88148,51.95865)">
                                <path fill="#B0171F" data-region="Campania"
                            ...
                            <path fill="#B0171F" data-region="Lazio" d="M404.512,613.385c0.292-0.473,2.533-1.542,4.98-2.375
                            ...
                            <path fill="#B0171F" data-region="Umbria" d="M370.865,518.534c0.538-1.005,0.742-2.444,0.453-3.197
                            ...
                            <path fill="#B0171F" data-region="Abruzzo"
                            ...
                            <path fill="#B0171F" data-region="Puglia" d="M727.704,724.486c0.519-6.754,1.72-9.814,5.216-13.289
                            ...
                            <path fill="#B0171F" data-region="Molise" d="M500.916,600.968c1.555,0,3.057-0.811,3.926-2.121
                            ...
                            <path fill="#B0171F" data-region="Basilicata"
                            ...
                            <g id="g3044" transform="matrix(0.948312,0,0,0.948312,-83.88148,51.95865)">
                                <path fill="#B0171F" data-region="Sardegna"
                    ...
                    <div id="single-region" class="col-12 col-lg-6 d-flex flex-wrap mb-5">
                        <div class="col-6 p-2" v-for="dateRegion in dateSelectedData" :key="dateRegion.codice_regione">
                            <a role="button" @click="setRegion(dateRegion.denominazione_regione)" class="text-decoration-none" data-bs-toggle="modal" data-bs-target="#modalId">
                                <div class="card-neo h-100" :id="dateRegion.codice_regione">
                                    <div class="card-body">
                                        <h4 class="card-title text-bs mb-5">{{ dateRegion.denominazione_regione }}</h4>
                                        <div class="d-flex">
                                            <div class="text-start text-b h5">
                                                {{ dateRegion.nuovi_positivi }} <i class="fas fa-lungs-virus"></i>
                                            </div>
                                            <div class="text-end text-b h5 ms-auto">
                                                {{ dateRegion.terapia_intensiva }} <i class="fas fa-procedures"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <!-- modal body -->
    <div class="modal fade" v-show="regionProvince" id="modalId" aria-hidden="true" aria-labelledby="modalIdM" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalIdM">Dati provinciali per la regione {{regionProvince}}</h5>
                    ...
                    <div class="text-start text-b h5">
                        <div class="table-responsive py-5">
                            <table class="table table-sm table-bordered border-danger">
                                ...
                                <tbody v-for="singleProvince in province" :key="singleProvince.codice_provincia">
                                    <tr v-if="singleProvince.denominazione_regione == regionProvince">
                                        <td>{{ singleProvince.denominazione_provincia }} ({{ singleProvince.sigla_provincia }})</td>
                                        <td>{{ singleProvince.totale_casi }}</td>
                                    </tr>
                                </tbody>
                                <tfoot>
                                    <tr>
                                        <td class="text-b text-end pe-4">Totale casi regione</td>
                                        <td class="text-bs">{{ totalProvince }}</td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
...
export default {
  ...
  beforeCreate() {
        ...
        .then(dati => {
            ...
            this.allDays = Array.from(new Set(this.dati.map(d => d.data)));

            this.dayMax = this.allDays.length-1 ;

            let slider = document.querySelector('#day');

            slider.max = this.dayMax;

            this.selectedDay(this.dayMax)
            
            this.colorMapPerDay(this.dateSelectedData)

            this.dayPrint = this.dateSelectedData[0].data.split("T")[0].split('-').reverse().join('-')

        })

        fetch('https://raw.githubusercontent.com/pcm-dpc/COVID-19/master/dati-json/dpc-covid19-ita-andamento-nazionale-latest.json')
        .then(response => response.json())
        .then(dateTodayApiIta => {

            // console.log(dateTodayApiIta[0].nuovi_positivi);
            this.maxDayForInput = dateTodayApiIta[0].data.split("T")[0];

            this.today = dateTodayApiIta[0].data.split("T")[0].split('-').reverse().join('-')

            this.newCases = dateTodayApiIta[0].nuovi_positivi

            this.totalCases = dateTodayApiIta[0].totale_casi

            this.totalDeath = dateTodayApiIta[0].deceduti

            this.totalHealed = dateTodayApiIta[0].dimessi_guariti

            this.positive = dateTodayApiIta[0].totale_positivi

            this.totalCases = new Intl.NumberFormat('it-IT').format(this.totalCases)
            this.totalDeath = new Intl.NumberFormat('it-IT').format(this.totalDeath)
            this.totalHealed = new Intl.NumberFormat('it-IT').format(this.totalHealed)
            this.positive = new Intl.NumberFormat('it-IT').format(this.positive)
        })
        ...
        .then(dateTodayApiRegion => {
            ...
            this.dateRegionsToday = dateTodayApiRegion
        ...
        //     this.provinceYesterday = province.filter(day => day.data.split("T")[0] == JSON.stringify(yesterday).split("T")[0].substring(1))
        //     let yesterdayDate  = this.provinceYesterday.map( p => {     
        //         return {
        //             cod : p.denominazione_provincia ,
        //             totale : p.totale_casi
        //             }
        //     })
        //     console.log(yesterdayDate);
            
            // this.provinceTodayCase = this.province.map( p => {     
            //     // console.log(p.codice_provincia);
            //     // console.log(p.totale_casi);
            //     // console.log(p.totale_casi - yesterdayDate.find((el) => el.cod == p.codice_provincia ).totale);
            //     // yesterdayDate.forEach(el => {
            //     //     if(el.codice_provincia == p.codice_provincia){
            //     //         let pippo =  {
            //     //             denominazione_regione: p.denominazione_regione,
            //     //             sigla_provincia: p.sigla_provincia,
            //     //             totale_casi: (p.totale_casi - el.totale_casi)
            //     //         }
            //     //         console.log(p.totale_casi - el.totale_casi);
            //     //     }
            //     // })
            //     // return pippo;
            // })
            // console.log(this.provinceTodayCase);
        // })
    },
    watch: {
        dayMax(dMax){
            this.selectedDay(dMax)
            this.colorMapPerDay(this.dateSelectedData)
            this.dayPrint = this.dateSelectedData[0].data.split("T")[0].split('-').reverse().join('-')
            this.dayMaxDate = this.dateSelectedData[0].data.split("T")[0];
        },
        dayMaxDate(dMaxD){
            for (const [key, day] of Object.entries(this.allDays)) {
                if (day.split('T')[0] == dMaxD) {
                    this.dayMax = key;
                }
            }
        },
        regionProvince(r){
            this.totalProvince = this.province.filter(region => region.denominazione_regione == r).map(t => t.totale_casi).reduce((accumulator, currentValue) => accumulator + currentValue)
        }
    },
    methods: {
        // hoverCard(nameRegion){
            // @click="hoverCard(dateRegion.denominazione_regione)"
        //     let regionsPath = document.querySelectorAll('[data-region')
        //     document.querySelector(`[data-region="${nameRegion}"]`).classList.add('region-click', 'border', 'border-outline-dark')
        //     document.querySelector(`[data-region="${nameRegion}"]`).style.opacity = 1;
        //     regionsPath.forEach(region => {
        //         if (region.dataset.region != nameRegion) {
        //             region.classList.remove('region-click', 'border', 'border-outline-dark')
        //             let singleRegion = this.dateRegionsToday.filter(r => r.denominazione_regione == region.dataset.region)
        //             let max = Math.max(...this.dateRegionsToday.map(d => d.nuovi_positivi));
        //             region.style.opacity = singleRegion[0].nuovi_positivi / max;
        //         }
        //     })
        // },
        setRegion(region) {
            this.regionProvince = region;
            
        },
        colorMapPerDay(dataDay) {
            let regionsPath = document.querySelectorAll('[data-region')            
            regionsPath.forEach(region => {
                let singleRegion = dataDay.filter(r => r.denominazione_regione == region.dataset.region)
                let max = Math.max(...dataDay.map(d => d.nuovi_positivi));
                region.style.opacity = singleRegion[0].nuovi_positivi / max;
            })
        },
        selectedDay(day){
            this.dateSelectedData = this.dati.filter(d => d.data == this.allDays[day])
        }
    }
}
